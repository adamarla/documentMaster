 ...
 */
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                                    ...
                                    protected gutenberg.blocs.EntryType localGroup ;
                           ...
                           * @return gutenberg.blocs.EntryType
                           */
                           public  gutenberg.blocs.EntryType getGroup(){
                               return localGroup;
                           }
                            ...
                            /**
                               ...
                               * @param param Group
                               */
                               public void setGroup(gutenberg.blocs.EntryType param){
                        ...
                        */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           * @return gutenberg.blocs.EntryType[]
                           */
                           public  gutenberg.blocs.EntryType[] getMembers(){
                               return localMembers;
                           }
                              ...
                              * @param param Members
                              */
                              public void setMembers(gutenberg.blocs.EntryType[] param){
                             ...
                             */
                             public void addMembers(gutenberg.blocs.EntryType param){
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":studentGroupType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "studentGroupType",
                                       ...
                                       if (localMembers!=null){
                                            for (int i = 0;i < localMembers.length;i++){
                                                if (localMembers[i] != null){
                                                 localMembers[i].serialize(new javax.xml.namespace.QName("http://gutenberg/blocs","members"),
                                                           xmlWriter);
                                                } else {
    ...
    public static class Factory{
        ...
        */
        public static StudentGroupType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            StudentGroupType object =
                new StudentGroupType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"studentGroupType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (StudentGroupType)gutenberg.blocs.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
