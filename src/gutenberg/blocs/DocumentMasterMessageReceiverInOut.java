        ...
        */
        ...
        if((op.getName() != null) && ((methodName = org.apache.axis2.util.JavaUtils.xmlNameToJavaIdentifier(op.getName().getLocalPart())) != null)){
            ...
            if("viewScans".equals(methodName)){
                ...
                gutenberg.blocs.ViewScansResponse viewScansResponse21 = null;
	                        gutenberg.blocs.ViewScans wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                        ...
                                        envelope = toEnvelope(getSOAPFactory(msgContext), viewScansResponse21, false, new javax.xml.namespace.QName("http://gutenberg/blocs",
                                                    "viewScans"));
                                    } else 

            if("tagQuestion".equals(methodName)){
                
                gutenberg.blocs.TagQuestionResponse tagQuestionResponse23 = null;
	                        gutenberg.blocs.TagQuestion wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                               ...
                                               tagQuestionResponse23 =
                                                   
                                                   
                                                         skel.tagQuestion(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), tagQuestionResponse23, false, new javax.xml.namespace.QName("http://gutenberg/blocs",
                                                    "tagQuestion"));
                                    } else 

            if("viewQuestions".equals(methodName)){
                
                gutenberg.blocs.ViewQuestionsResponse viewQuestionsResponse25 = null;
	                        gutenberg.blocs.ViewQuestions wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                               ...
                                               viewQuestionsResponse25 =
                                                   
                                                   
                                                         skel.viewQuestions(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), viewQuestionsResponse25, false, new javax.xml.namespace.QName("http://gutenberg/blocs",
                                                    "viewQuestions"));
                                    } else 

            if("writeQuestion".equals(methodName)){
                
                gutenberg.blocs.WriteQuestionResponse writeQuestionResponse27 = null;
	                        gutenberg.blocs.WriteQuestion wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                               ...
                                               writeQuestionResponse27 =
                                                   
                                                   
                                                         skel.writeQuestion(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), writeQuestionResponse27, false, new javax.xml.namespace.QName("http://gutenberg/blocs",
                                                    "writeQuestion"));
                                    } else 
            ...
            if("annotateScan".equals(methodName)){
                ...
                gutenberg.blocs.AnnotateScanResponse annotateScanResponse31 = null;
	                        gutenberg.blocs.AnnotateScan wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                               ...
                                               annotateScanResponse31 =
                                                   
                                                   
                                                         skel.annotateScan(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), annotateScanResponse31, false, new javax.xml.namespace.QName("http://gutenberg/blocs",
                                                    "annotateScan"));
                                    } else 

            if("buildQuiz".equals(methodName)){
                
                gutenberg.blocs.BuildQuizResponse buildQuizResponse33 = null;
	                        gutenberg.blocs.BuildQuiz wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                        ...
                                        envelope = toEnvelope(getSOAPFactory(msgContext), buildQuizResponse33, false, new javax.xml.namespace.QName("http://gutenberg/blocs",
                                                    "buildQuiz"));
                                    } else 

            if("generateSuggestionForm".equals(methodName)){
                
                gutenberg.blocs.GenerateSuggestionFormResponse generateSuggestionFormResponse35 = null;
	                        gutenberg.blocs.GenerateSuggestionForm wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                               ...
                                               generateSuggestionFormResponse35 =
                                                   
                                                   
                                                         skel.generateSuggestionForm(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), generateSuggestionFormResponse35, false, new javax.xml.namespace.QName("http://gutenberg/blocs",
                                                    "generateSuggestionForm"));
                                    } else 

            if("receiveScans".equals(methodName)){
                
                gutenberg.blocs.ReceiveScansResponse receiveScansResponse37 = null;
	                        gutenberg.blocs.ReceiveScans wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                               ...
                                               receiveScansResponse37 =
                                                   
                                                   
                                                         skel.receiveScans(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), receiveScansResponse37, false, new javax.xml.namespace.QName("http://gutenberg/blocs",
                                                    "receiveScans"));
                                    } else 

            if("assignQuiz".equals(methodName)){
                
                gutenberg.blocs.AssignQuizResponse assignQuizResponse39 = null;
	                        gutenberg.blocs.AssignQuiz wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                               ...
                                               assignQuizResponse39 =
                                                   
                                                   
                                                         skel.assignQuiz(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), assignQuizResponse39, false, new javax.xml.namespace.QName("http://gutenberg/blocs",
                                                    "assignQuiz"));
